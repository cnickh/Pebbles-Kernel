...
extern void set_ds(unsigned short ds);
extern unsigned short get_es(void);
extern void set_es(unsigned short es);
extern unsigned short get_fs(void);
extern void set_fs(unsigned short fs);
extern unsigned short get_gs(void);
extern void set_gs(unsigned short gs);
extern unsigned short get_ss(void);
extern void set_ss(unsigned short ss);
